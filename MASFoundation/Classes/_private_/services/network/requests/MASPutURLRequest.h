...
/**
 * The HTTP PUT specific version of the MASURLRequest:NSURLRequest.
 */
@interface MASPutURLRequest : MASURLRequest
...
/**
 * Retrieve an MASPutURLRequest for the PUT request of given end point.
 *
 ...
 * @return MASPutURLRequest which could be used to create NSURLSessionDataTask.
 */
