...
{
    //
    //  Making sure user has valid session before making a call to register for Push Notification
    //
    [[MASModelService sharedService] validateCurrentUserSession:^(BOOL completed, NSError *error) {
        ...
        if (completed && !error)
        {
            ...
            // DeviceToken
            parameterInfo[MASPushNotificationDeviceTokenRequestResponseKey] = deviceToken;
