...
### Enhancement
Swift code is added to the iOS Guide. The iOS API Reference documentation is based on OBJ-C, but the Obj-C code can be used seamlessly with your Swift code. See the usage section for details.
