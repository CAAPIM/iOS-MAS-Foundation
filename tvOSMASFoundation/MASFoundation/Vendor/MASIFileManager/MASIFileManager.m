...
@implementation MASIFileManager
...
{
    return [[MASIFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MASIFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MASIFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MASIFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MASIFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[MASIFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
